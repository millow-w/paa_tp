...
Integrantes: Camila Aparecida, Thiago Ayolphi e Yasmin Altino
...
## Como compilar:
- Primeiro crie uma instância de sua preferência com python3 gerador_instancias.py
- Depois, caso queira, rode experimentos.py para testar os algoritmos separadamente
- O benchmark.py testa 10 vezes cada instância e pôe tudo dentro de um arquivo .csv na pasta resultados
